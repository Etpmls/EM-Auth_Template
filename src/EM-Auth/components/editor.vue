...
export default {
  ...
  data() {
    return {
      ...
      init: {
        vue_this: this,
        language_url: '/static/em-auth/tinymce/zh_CN.js',
        language: 'zh_CN',
        skin_url: '/static/em-auth/tinymce/skins/ui/oxide',
        content_css:
            '/static/em-auth/tinymce/skins/content/default/content.min.css',
