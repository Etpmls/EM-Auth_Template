  ...
  <div class="homepage-hero-module">
    <div class="video-container">
      ...
      <video :style="fixStyle" autoplay loop class="fillWidth" @canplay="canplay">
        <source src="@/EM-Auth/assets/login/login.mp4" type="video/mp4">
        {{ lang('m.video_not_supported') }}
        <source src="@/EM-Auth/assets/login/login.mp4" type="video/webm">
        {{ lang('m.video_not_supported') }}
      </video>
      <div v-if="!vedioCanPlay" class="poster hidden">
        <img :style="fixStyle" src="@/EM-Auth/assets/login/login.jpg" alt="">
      </div>
