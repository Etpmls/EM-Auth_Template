...
<script>
import { getUserToken, getBaseUrl } from '@/Etpmls-Micro/utils/utils'
...
export default {
  ...
  data() {
    return {
      ...
      init: {
        vue_this: this,
        language_url: '/static/etpmls-micro/tinymce/zh_CN.js',
        language: 'zh_CN',
        skin_url: '/static/etpmls-micro/tinymce/skins/ui/oxide',
        content_css:
            '/static/etpmls-micro/tinymce/skins/content/default/content.min.css',
